...
class FSAD_Dataset_train(_MetaDatasetTrain):
    def __init__(self, dataset_path=r'C:\Users\Administrator\Desktop\dataset\BTech_Dataset_transformed', class_name='01', is_train=True, resize=256, shot=2, batch=32):
...
class FSAD_Dataset_test(_MetaDatasetTest):
    def __init__(self, dataset_path=r'C:\Users\Administrator\Desktop\dataset\BTech_Dataset_transformed', class_name='01', is_train=True, resize=256, shot=2):
